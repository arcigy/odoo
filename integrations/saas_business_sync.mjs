...
const BUSINESS_METRIC_CODES = new Set([
  ...
  "ai_assisted_pr_count", "ai_assisted_pr_average_diff_lines",
  "ai_assisted_changed_file_count", "ai_assisted_modules_touched_per_change",
  "ai_assisted_security_sensitive_file_touch_count",
  "ai_assisted_billing_file_touch_count", "ai_assisted_auth_file_touch_count",
  "ai_assisted_db_migration_count", "ai_assisted_dependency_proposal_count",
  "ai_assisted_dependency_rejection_count", "ai_assisted_tests_added_count",
  "ai_assisted_tests_modified_count", "ai_assisted_tests_deleted_count",
  "ai_change_security_review_coverage", "ai_assisted_release_rollback_rate",
  "ai_assisted_release_hotfix_rate", "ai_assisted_escaped_defect_count",
  "ai_assisted_authorization_defect_count",
  "ai_assisted_performance_regression_count", "ai_assisted_query_regression_count",
  "ai_assisted_cost_regression_count", "ai_assisted_change_reopen_rate",
  "ai_assisted_change_repair_p50_seconds", "ai_change_review_risk_p95_score",
  ...
  "branch_age_average_seconds", "branch_oldest_age_seconds", "stale_branch_count",
  "merge_conflict_count", "direct_main_push_count", "branch_protection_bypass_count",
  "failed_required_check_count", "emergency_merge_count",
  "unreviewed_production_change_count", "build_count",
  "build_duration_p95_seconds", "build_queue_p95_seconds", "flaky_job_rate",
  "unit_test_pass_rate", "integration_test_pass_rate", "e2e_test_pass_rate",
  "performance_test_pass_rate", "security_test_pass_rate", "flaky_test_count",
  "flaky_test_age_seconds", "ignored_test_count", "skipped_test_count",
  "test_duration_p95_seconds", "critical_path_coverage_rate", "mutation_score_rate",
  "bug_reopen_rate", "active_feature_flag_count",
  "feature_flag_without_owner_count", "feature_flag_without_expiry_count",
  "feature_flag_age_p95_seconds", "permanent_feature_flag_count",
  "feature_flag_untested_on_count", "feature_flag_untested_off_count",
  "feature_flag_rollback_count", "module_boundary_violation_count",
  "cyclic_dependency_count", "duplicate_code_rate", "complexity_regression_rate",
  "oversized_file_count", "oversized_function_count", "dead_code_finding_count",
  "unused_dependency_count", "todo_count", "tech_debt_item_count",
  "tech_debt_age_average_seconds", "sensitive_code_without_codeowner_review_count",
]);
